...
const navItems = [
  ...
  {id: "chat", label: "Chat", icon: "ri-chat-1-line"},
    ...
    `}
      >
        ...
        <div className="mb-8 text-center">
          ...
          <h2 className="text-xl font-bold font-[Space_Grotesk]"> Izzet Sahal</h2>
          <p className="text-sm text-zinc-400">Web Engineer</p>
        </div>
        {/* Navigation */}
